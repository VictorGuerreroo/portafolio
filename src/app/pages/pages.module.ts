...
import { PaginacionComponent } from './portafolio/paginacion/paginacion.component';


@NgModule({
  declarations: [SobreMiComponent, InicioComponent, CurriculumComponent, Portafolio1Component, Portafolio2Component, Portafolio3Component, Portafolio4Component, ContactoComponent, PaginacionComponent],
  imports: [
    CommonModule,
    PagesRoutingModule
  ]
